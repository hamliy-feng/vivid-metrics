  ...
  const trendOption: EChartsOption = {
    tooltip: {
      ...
      formatter: (params: unknown) => {
        ...
        return `${ps[0].name}<br/>播放量: ${ps[0].value.toLocaleString()}`;
      },
    },
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="glass-card rounded-2xl p-4">
        ...
        <div className="h-44"><EChart option={trendOption} style={{ height: "100%" }} /></div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="glass-card rounded-2xl p-4">
          <div className="text-sm font-medium text-[var(--app-text-secondary)] mb-3">前10作品播放排行</div>
          <div className="h-52"><EChart option={barOption} style={{ height: "100%" }} /></div>
        </div>
        <div className="glass-card rounded-2xl p-4">
          <div className="text-sm font-medium text-[var(--app-text-secondary)] mb-3">内容类型分布</div>
          <div className="h-52"><EChart option={pieOption} style={{ height: "100%" }} /></div>
        </div>
      </div>
      <div className="glass-card rounded-2xl p-4">
...
function DouyinView() {
  ...
  const interactionOption: EChartsOption = {
    tooltip: { trigger: "axis" },
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="glass-card rounded-2xl p-4">
        ...
        <div className="h-52"><EChart option={trendOption} style={{ height: "100%" }} /></div>
      </div>
      <div className="glass-card rounded-2xl p-4">
        <div className="text-sm font-medium text-[var(--app-text-secondary)] mb-3">互动数据趋势（点赞 / 分享 / 评论）</div>
        <div className="h-44"><EChart option={interactionOption} style={{ height: "100%" }} /></div>
      </div>
